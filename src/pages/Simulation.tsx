...
export default function Simulation() {
  ...
  const nextMonth = () => {
    if (result && currentMonth < result.months.length - 1) {
    ...
    <div className="container py-8">
      ...
      {!showingResults ? (
            ...
            {CRISES.map((crisis) => (
              ...
              >
                <div className="mb-2 flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-display text-lg font-semibold text-foreground">{crisis.label}</p>
        ...
        <div className="space-y-8">
          ...
          {/* Timeline */}
          <div>
            <h2 className="mb-4 font-display text-xl font-semibold text-foreground">Month-by-Month</h2>
            <div className="mb-4">
                  ...
                  <CardContent className="p-6">
                    ...
                    <div className="mb-4 flex gap-6">
                      <div>
                        ...
                        <p className={`font-mono text-xl font-bold ${result.months[currentMonth].netWorthChange >= 0 ? "text-primary" : "text-destructive"}`}>
                      ...
                      <div>
                        ...
                        <p className={`font-mono text-xl font-bold ${result.months[currentMonth].debtCostChange <= 0 ? "text-primary" : "text-destructive"}`}>
          ...
          <Card className="shadow-card">
            <CardHeader>
              <CardTitle className="font-display text-xl">Your Action Plan</CardTitle>
